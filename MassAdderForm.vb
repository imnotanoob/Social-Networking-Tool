...
#End Region
    ...
    Private Sub MassAdderForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        fix.Start()
        frstSignOut.Start()
        count.Start()
    End Sub
    ...
    Private Sub GroupPanel1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GroupPanel1.Click
        If MainForm.MainEE.Text = "5" Then
            MainForm.MainEE.Text = "6"
        End If
    End Sub
